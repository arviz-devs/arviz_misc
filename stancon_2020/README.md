...
for convenience and speed, see [this post](https://discourse.jupyter.org/t/tip-speed-up-binder-launches-by-pulling-github-content-in-a-binder-link-with-nbgitpuller/922?u=oriolabril).
...
* Make sure the notebook metadata has `"livereveal": {"autolaunch": true}` for
  the presentation to be generated automatically from the `.ipynb` file. More
  details in [RISE documentation](https://rise.readthedocs.io/en/stable/customize.html)
